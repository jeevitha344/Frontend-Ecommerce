...
text:"Kid's collection"
  ...
  return (
    <div className='relative '>
       <div className='w-fit  grid grid-col-1  relative right-10   md:grid-cols-2 md:w-3xl md:items-center   lg:grid-cols-3  lg:w-7xl  ml-40 gap-6  '>
      ...
      <img src= {element.img} alt='' className='w-full h-full object-cover rounded-lg shadow-md'/>
       <p className='absolute top-20 left-12 font-bold  '>{element.text}</p>
       <p className='text-gray-600 absolute top-29 left-15'>Shop Now</p>
        </div>
       )}
        </div> 
    </div>
